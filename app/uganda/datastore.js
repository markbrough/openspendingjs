...
(function($) {
  ...
  OpenSpending.Search = function(config) {
    ...
    my.entityUrl = function(entity) {
      if ('name' in entity) {
        var entity_id = entity.id + '/' + entity.name;
      } else {
    ...
    my.swgShow = function(entity) {
      var out = $('<div />').append(
          $('<a />').text(entity.label).attr('href', (my._config.endpoint + 'ugandabudget/sector/' + entity.name)).attr("target","_blank")
        ).html();
      return out
    };
   ...
   my.sectorobjectiveShow = function(entity) {
      var out = $('<div />').append(
          $('<a />').text(entity.label).attr('href', (my._config.endpoint + 'ugandabudget/subsector/' + entity.name)).attr("target","_blank")
        ).html();
      return out
    };
